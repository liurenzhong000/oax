...
public class SysConfigServiceImpl implements SysConfigService {
	...
	/**
	 * 根据sysConfig的name查询value
	 */
	@DataSource(DataSourceType.SLAVE)
	public String getConfig(String name) {
		String value ="";
		List<SysConfig> sysConfigList = redisUtil.getList(RedisKeyEnum.SYSCONFIG_LIST.getKey(), SysConfig.class);
		
		if(sysConfigList==null) {
			sysConfigList=sysConfigMapper.selectAll();
			redisUtil.setList(RedisKeyEnum.SYSCONFIG_LIST.getKey(), sysConfigList);
		}
