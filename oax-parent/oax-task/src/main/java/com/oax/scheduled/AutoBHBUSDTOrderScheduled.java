...
@Slf4j
@Controller
public class AutoBHBUSDTOrderScheduled {

    private String oaxApiKey="XBTC20181BHB";

    private String oaxApiSecret="XBTC201893677";
...
//    @Scheduled(fixedRate = 1000 * 60)
    public void autoMakeOrder() {
        ...
        int endNumber = 700;
        //价格下限,盘低
        double startPrice = 1.0606;
        //价格上限，盘高
        double endPrice = 1.0822;
        //价格精度
        double precision = 0.00054;
        //交易对
        int markerId = 77;
        //交易对名称
        String tradeName="BHB/USDT";
