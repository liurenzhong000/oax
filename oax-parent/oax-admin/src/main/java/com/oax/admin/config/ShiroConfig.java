...
import com.oax.admin.shiro.config.RestShiroFilterFactoryBean;
...
public class ShiroConfig {
    ...
    @Autowired
    private ShiroFilterChainManager shiroService;
    ...
    @Value("${shiro.session.redis.expire}")
    ...
    public RedisSessionDAO redisSessionDAO() {
        ...
        //默认也是1800
        redisSessionDAO.setExpire(redisExpire);
